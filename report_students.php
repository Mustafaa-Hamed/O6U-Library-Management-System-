...
<div class="container">
    <form method="post" action="report_studentsD.php">
        <div class="facultydiv">
            <label for="college">Your Faculty:</label>
        ...
        <div class="YearDiv">
            <label style="margin-left: 20px" for="level">Your Level:</label>
            <select class="form-select"style="width: 150px" id="level" name="level">
        ...
        <button class="btn" type="submit" style="margin-left: 20px" name="submit">Download</button>
    </form>
